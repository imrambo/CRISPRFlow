...
neighbor_gene_clusters = fetch_clusters(anchor_gff_df=crispr_detect_gff, gene_gff_df=prodigal_gff_df, gene_seq_dict=prodigal_aa_dict, winsize=opts.window_extent, att_fs=';')
